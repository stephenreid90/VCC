...
24 May 2026 — Phase 3.5 smoke-test DCF + incremental calibration pass closed out. Framework end-to-end pipeline confirmed working; baseline calibrated (margin / net debt / rigorous WACC build); calibrated Muddle Through AUD 2.53/share. Design principle adopted: valuation inputs exposed as named components, not opaque scalars. Ready for Step 6 (production translator) with §11.3 time-profile library + §11.4.2 consistency rules as the two highest-priority items.
