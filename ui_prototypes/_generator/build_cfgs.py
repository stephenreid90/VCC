...
dnl = {
 ...
 "_assum":[
   ...
   ["Transition-cost normalisation","+0.35 pp","judgment","FY24 and FY25 are a business emerging from a demerger. Sized only on the corporate-cost reduction the company has actually reported \u2014 \u201cCorporate costs reduced by $6m\u201d, 1H26 result, annualised on the base revenue. Declared separately so it can be argued about without touching the observed rate."],  # ssot-allow: display
